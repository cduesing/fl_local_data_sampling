...
class ANNetwork(nn.Module):
    ...
    def __init__(self, num_features, num_classes):
        ...
        self.fc1 = nn.Linear(num_features, int(3*num_features/4))
        self.fc2 = nn.Linear(int(3*num_features/4), int(num_features/2))
        self.fc3 = nn.Linear(int(num_features/2), int(num_features/4))
        self.fc4 = nn.Linear(int(num_features/4), num_classes)
    ...
    def forward(self,x,labels=None):
        ...
        x = self.a(self.d(self.fc1(x)))
        x = self.a(self.d(self.fc2(x)))
        x = self.a(self.d(self.fc3(x)))
        logits = self.fc4(x)
        loss = None
